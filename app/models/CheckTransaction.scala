...
case class CheckTransaction(card: OriginalCard,
...
object CheckTransaction {
  ...
  implicit val inputForm: Format[CheckTransaction] = (
    ...
    ) (CheckTransaction.apply, unlift(CheckTransaction.unapply))
  ...
  def toRowID(origTrx: CheckTransaction) : Row = {
    var ogRowSeq = Seq(
